...
<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
        ...
        <div class="download-section">
            <div class="container">
                <div class="col-lg-8 col-lg-offset-2">
                    ...
                    <a href="#" class="btn btn-default btn-lg" role="button" data-toggle="modal" data-target="#login-modal">Estacionate!</a>
                </div>
            </div>
                  ...
                  <div id="div-forms">
                    ...
                    <form id="login-form">
                          ...
                          <div id="icon-login-msg" class="glyphicon glyphicon-chevron-right"></div>
                            <span id="text-login-msg">Ingresa tu usuario y contraseña.</span>
                        </div>
				    		        <input id="login_email" class="form-control" type="text" placeholder="Mail" required>
                    ...
                    <form id="lost-form" style="display:none;">
                          ...
                          <div id="icon-lost-msg" class="glyphicon glyphicon-chevron-right"></div>
                            <span id="text-lost-msg">Ingresa tu mail.</span>
                        </div>
		    				        <input id="lost_email" class="form-control" type="text" placeholder="Mail" required>
            			    </div>
		    		          <div class="modal-footer">
                        <div>
    ...
    <section id="contact" class="container content-section text-center">
        <div class="row">
            <div class="col-lg-8 col-lg-offset-2">
                <h2>Contáctanos</h2>
                <p>Si necesitas ayuda, quieres sugerirnos algo o necesitas más información, no dudes en contactarnos.</p>
                <p><a href="mailto:contacto@parkinguai.cl">contacto@parkinguai.cl</a>
                </p>
                <ul class="list-inline banner-social-buttons">
                    <li>
                        <a href="http://www.anthea.cl/parkinguai" class="btn btn-default btn-lg"><i class="fa fa-facebook fa-fw"></i> <span class="network-name">Facebook</span></a>
                    </li>
                    <li>
                        <a href="https://github.com/feldrok/parkinguai" class="btn btn-default btn-lg"><i class="fa fa-github fa-fw"></i> <span class="network-name">Github</span></a>
                    </li>
                    <!--<li>
